var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},o={},t={},n=e.parcelRequire94c2;null==n&&((n=function(e){if(e in o)return o[e].exports;if(e in t){var n=t[e];delete t[e];var r={id:e,exports:{}};return o[e]=r,n.call(r.exports,r,r.exports),r.exports}var a=Error("Cannot find module '"+e+"'");throw a.code="MODULE_NOT_FOUND",a}).register=function(e,o){t[e]=o},e.parcelRequire94c2=n);var r=n("amYBK"),a=new(function(e){return e&&e.__esModule?e.default:e}(function(){var e=function(){function o(e){return r.appendChild(e.dom),e}function t(e){for(var o=0;o<r.children.length;o++)r.children[o].style.display=o===e?"block":"none";n=e}var n=0,r=document.createElement("div");r.style.cssText="position:fixed;top:0;left:0;cursor:pointer;opacity:0.9;z-index:10000",r.addEventListener("click",function(e){e.preventDefault(),t(++n%r.children.length)},!1);var a=(performance||Date).now(),l=a,i=0,s=o(new e.Panel("FPS","#0ff","#002")),f=o(new e.Panel("MS","#0f0","#020"));if(self.performance&&self.performance.memory)var d=o(new e.Panel("MB","#f08","#201"));return t(0),{REVISION:16,dom:r,addPanel:o,showPanel:t,begin:function(){a=(performance||Date).now()},end:function(){i++;var e=(performance||Date).now();if(f.update(e-a,200),e>l+1e3&&(s.update(1e3*i/(e-l),100),l=e,i=0,d)){var o=performance.memory;d.update(o.usedJSHeapSize/1048576,o.jsHeapSizeLimit/1048576)}return e},update:function(){a=this.end()},domElement:r,setMode:t}};return e.Panel=function(e,o,t){var n=1/0,r=0,a=Math.round,l=a(window.devicePixelRatio||1),i=80*l,s=48*l,f=3*l,d=2*l,c=3*l,u=15*l,m=74*l,p=30*l,_=document.createElement("canvas");_.width=i,_.height=s,_.style.cssText="width:80px;height:48px";var v=_.getContext("2d");return v.font="bold "+9*l+"px Helvetica,Arial,sans-serif",v.textBaseline="top",v.fillStyle=t,v.fillRect(0,0,i,s),v.fillStyle=o,v.fillText(e,f,d),v.fillRect(c,u,m,p),v.fillStyle=t,v.globalAlpha=.9,v.fillRect(c,u,m,p),{dom:_,update:function(s,b){n=Math.min(n,s),r=Math.max(r,s),v.fillStyle=t,v.globalAlpha=1,v.fillRect(0,0,i,u),v.fillStyle=o,v.fillText(a(s)+" "+e+" ("+a(n)+"-"+a(r)+")",f,d),v.drawImage(_,c+l,u,m-l,p,c,u,m-l,p),v.fillRect(c+m-l,u,l,p),v.fillStyle=t,v.globalAlpha=.9,v.fillRect(c+m-l,u,l,a((1-s/b)*p))}}},e}()));a.showPanel(0),document.body.appendChild(a.dom);const l=document.querySelector("#c"),i=l.getContext("webgl2",{alpha:!1});i.clearColor(.5,.5,.75,1),i.enable(i.BLEND),i.blendFunc(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA);const s=new Float32Array(4e5);for(let e=0;e<2;e++){let o=Math.random()-.5,t=Math.random()-.5;for(let n=0;n<1e5;n++){let r=(2*n+e)*2;s[r+0]=o,s[r+1]=t}}for(let e=0;e<1e5;e++){let o=2*Math.PI*e/1e5;s[4*e+0]+=.05*Math.cos(o),s[4*e+1]+=.05*Math.sin(o)}const f=new Float32Array(4e5),d=r.createBufferFromTypedArray(i,s,i.ARRAY_BUFFER,i.DYNAMIC_DRAW),c=r.createBufferFromTypedArray(i,s,i.ARRAY_BUFFER,i.DYNAMIC_DRAW),u=r.createBufferFromTypedArray(i,f,i.ARRAY_BUFFER,i.DYNAMIC_DRAW),m=r.createBufferFromTypedArray(i,f,i.ARRAY_BUFFER,i.DYNAMIC_DRAW),p=r.createBufferInfoFromArrays(i,{old_pos:{buffer:d,numComponents:4,type:Float32Array},new_pos:{buffer:c,numComponents:4,type:Float32Array},old_vel:{buffer:u,numComponents:4,type:Float32Array},new_vel:{buffer:m,numComponents:4,type:Float32Array}}),_=r.createBufferInfoFromArrays(i,{old_pos:{buffer:c,numComponents:4,type:Float32Array},new_pos:{buffer:d,numComponents:4,type:Float32Array},old_vel:{buffer:m,numComponents:4,type:Float32Array},new_vel:{buffer:u,numComponents:4,type:Float32Array}}),v=r.createBufferInfoFromArrays(i,{pos:{buffer:d,numComponents:2,type:Float32Array}}),b=r.createBufferInfoFromArrays(i,{pos:{buffer:c,numComponents:2,type:Float32Array}}),w=r.createProgramInfo(i,[`#version 300 es
    ...
    `]),y=r.createTransformFeedback(i,w,_),h=r.createTransformFeedback(i,w,p);i.bindBuffer(i.ARRAY_BUFFER,null),console.log("calc: ",2e5),console.log("real: ",v.numElements);let F={update_bi:p,tf:h,draw_bi:b},R={update_bi:_,tf:y,draw_bi:v},g=null,S=[0,0];document.addEventListener("mousedown",e=>{g=[e.offsetX,e.offsetY]}),document.addEventListener("mouseup",e=>{let o=[e.offsetX,e.offsetY];S=[-(.01*(o[0]-g[0])),(o[1]-g[1])*.01],g=null}),requestAnimationFrame(function e(o){a.update(),r.resizeCanvasToDisplaySize(l)&&i.viewport(0,0,i.drawingBufferWidth,i.drawingBufferHeight),i.useProgram(w.program),r.setBuffersAndAttributes(i,w,F.update_bi),i.enable(i.RASTERIZER_DISCARD),i.bindTransformFeedback(i.TRANSFORM_FEEDBACK,F.tf),r.setUniforms(w,{u_impulse:S}),i.beginTransformFeedback(i.POINTS),i.drawArrays(i.POINTS,0,1e5),i.endTransformFeedback(),i.disable(i.RASTERIZER_DISCARD),i.bindTransformFeedback(i.TRANSFORM_FEEDBACK,null),i.bindBuffer(i.ARRAY_BUFFER,null),i.bindBuffer(i.TRANSFORM_FEEDBACK_BUFFER,null),S=[0,0],i.clear(i.COLOR_BUFFER_BIT),i.useProgram(A.program),r.setBuffersAndAttributes(i,A,F.draw_bi),i.drawArrays(i.POINTS,0,2e5);{let e=F;F=R,R=e}requestAnimationFrame(e)});
//# sourceMappingURL=index.fd1a75c3.js.map
